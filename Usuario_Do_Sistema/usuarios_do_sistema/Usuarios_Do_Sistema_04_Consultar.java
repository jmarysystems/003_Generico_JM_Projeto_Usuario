 ...
 * @author AnaMariana
 */
public class Usuarios_Do_Sistema_04_Consultar extends javax.swing.JPanel {
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////     
     ...
     * @param Home2 */
    public Usuarios_Do_Sistema_04_Consultar( Home Home2 ) {
        initComponents();
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////             
    ...
    private void initComponents() {
        ...
        jLabel11.setText("Usuários do Sistema - Consulta");
        ...
        jButton6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens_internas/livroTp.gif"))); // NOI18N
        ...
        if( contentsX.equals("") ){
            ...
            if( tipoConsulta.equals("TUDO") ){
                ...
                if( !rbusca.equals("") ){
                    ...
                    Exportando.pbg.setMaximum( UsuarioSistema.size() );
                    
                    for (int it = 0; it < UsuarioSistema.size(); it++){
                        Exportando.pbg.setValue( it );
                        
                        setar_na_tabela( UsuarioSistema.get(it) );
                    }
                }
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
                            ...
                            if( tipoConsulta.equals("CÓDIGO AUXILIAR") ){
                                ...
                                if( !rbusca.equals("") ){
                                    ...
                                    setar_na_tabela( UsuarioSistema.get(0) );
                                } 
                                else{
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////                                    
                                    tmPesquisa.addRow(new Object[]{ "", material_procurado, "", "", "",
                                        "", "", "", "",
                                        "", "" }); 
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////                                    
                                }
...
private void setar_na_tabela(UsuarioSistema UsuarioSistema){
        try{      
            ...
            String permitirAcessoAoSistema = "";
            String dataCadastro = "";
            String dataAlteracao = "";
            String dataUltimaAlteracaoSenha = "";
            int idUsuarioSistemaCadastro = 0;
            int idUsuarioSistemaAlteracao = 0;    
            
//////////////////////////////////////////////////////////////////////////////////////////////////////////                            
            String rbusca = ""; try{ rbusca = UsuarioSistema.getLogin(); }catch( Exception e ){}
            if( !rbusca.equals("") ){
                
                SimpleDateFormat formatter = new SimpleDateFormat("dd/MM/yyyy HH:mm:ss");
                                    
                try{ id                       = UsuarioSistema.getId();                                           }catch( Exception e ){}
                try{ codigoAuxiliar           = UsuarioSistema.getCodigoAuxiliar();                               }catch( Exception e ){}
                try{ login                    = UsuarioSistema.getLogin();                                        }catch( Exception e ){}
                try{ senha                    = UsuarioSistema.getSenha();                                        }catch( Exception e ){}
                try{ emailRecuperacao         = UsuarioSistema.getEmailRecuperacao();                             }catch( Exception e ){}
                try{ permitirAcessoAoSistema  = UsuarioSistema.getPermitirAcessoAoSistema();                      }catch( Exception e ){}                    
                try{ dataCadastro             = formatter.format( UsuarioSistema.getDataCadastro());              }catch( Exception e ){}
                try{ dataAlteracao            = formatter.format( UsuarioSistema.getDataAlteracao());             }catch( Exception e ){}
                try{ dataUltimaAlteracaoSenha = formatter.format( UsuarioSistema.getDataUltimaAlteracaoSenha());  }catch( Exception e ){}
                try{ idUsuarioSistemaCadastro = UsuarioSistema.getIdUsuarioSistemaCadastro().getId();             }catch( Exception e ){}
                try{ idUsuarioSistemaAlteracao = UsuarioSistema.getIdUsuarioSistemaAlteracao().getId();           }catch( Exception e ){}
            }                               
///////////////////////////////////////////////////////////////////////////////////////////////////////////             
            
            tmPesquisa.addRow(new Object[]{ id, codigoAuxiliar, login, senha, emailRecuperacao,
                permitirAcessoAoSistema, dataCadastro, dataAlteracao, dataUltimaAlteracaoSenha,
                idUsuarioSistemaCadastro, idUsuarioSistemaAlteracao }); 
        } catch( Exception e ){}
    }
            ...
            if ( tbPesquisa.getSelectedRow() != -1){
                ...
                if( lbVisualizar.isEnabled() == true ){
                    ...
                    if( !rbusca.equals("") ){
                        ...
                        new Usuarios_Do_Sistema_02_Cadastrar_Visualizar( Home, jTabbedPane1, "Alterando...", List_2_UsuarioSistema.get(0) ) );
                    }
            ...
            if ( tbPesquisa.getSelectedRow() != -1){
                ...
                if( lbVisualizar.isEnabled() == true ){
                    ...
                    if( !rbusca.equals("") ){
                        ...
                        new Usuarios_Do_Sistema_02_Cadastrar_Visualizar( Home, jTabbedPane1, "Visualizando...", List_2_UsuarioSistema.get(0) ) );
                    }
            ...
            switch(opcao){
                ...
                case 1:
                    ...
                    tmPesquisa = new DefaultTableModel( null, new String[]{ 
                        "ID", "CÓDIGOAUX", "LOGIN", "SENHA", "EMAIL", "ACESSO AO SISTEMA", "DATA CADASTRO", "DATA ÚLTIMA ALTERACAO", "DATA ULTIMA ALTERACAO SENHA", "USUÁRIO QUE CADASTROU", "ULTIMO USUÁRIO QUE ALTEROU" } );
                    tbPesquisa.setModel(tmPesquisa);
                break;    

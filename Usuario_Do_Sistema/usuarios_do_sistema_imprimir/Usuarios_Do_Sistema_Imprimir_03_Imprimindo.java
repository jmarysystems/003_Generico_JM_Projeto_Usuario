 ...
 * @author Ana
 */
public class Usuarios_Do_Sistema_Imprimir_03_Imprimindo extends Thread { 
    ...
    public Usuarios_Do_Sistema_Imprimir_03_Imprimindo( List<File> lista_Arquivos2  ){   
    ...
    public void impressora(){  
        synchronized(this) { 
            ...
            Usuarios_Do_Sistema_Imprimir_04_Impressora Impressora = new Usuarios_Do_Sistema_Imprimir_04_Impressora( "" );
    ...
    public void imprimirComPropriedadesEConfigurações() { 
        ...
        */
        ...
        synchronized(this) {
            ...
            synchronized(this) {
                Printable pTable  = new Usuarios_Do_Sistema_Imprimir_05_PrintX_JM( htmlPanePrincipal, PrinterJob, aset );    

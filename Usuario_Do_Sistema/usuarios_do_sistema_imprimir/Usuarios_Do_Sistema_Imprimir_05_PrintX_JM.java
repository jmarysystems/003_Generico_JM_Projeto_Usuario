 ...
 * @author i
 */
public class Usuarios_Do_Sistema_Imprimir_05_PrintX_JM implements Printable {
    PrinterJob pJob2;
    ...
    public Usuarios_Do_Sistema_Imprimir_05_PrintX_JM( JEditorPane pane, PrinterJob pJob, PrintRequestAttributeSet aset ) { try { 

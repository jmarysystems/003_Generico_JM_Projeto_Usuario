 ...
 * @author Ana
 */
public class Usuarios_Do_Sistema_Imprimir_02_Criar_Html { 
    ...
    public Usuarios_Do_Sistema_Imprimir_02_Criar_Html( String pagina2, int qtdLinha2, int numeroPagina2, int qtd_linhas_por_pg ) {  
        ...
        synchronized(this) {  
            ...
            synchronized(this) {
                ...
                if ( new File( arq_html ).exists() == false ) { 
                    ...
                    if ( Arquivo_Ou_Pasta.criar_Arquivo_Iso_Boo_Tipo_UTFISO( arq_html, arquivoASerC, "ISO-8859-1" ) == true ) {

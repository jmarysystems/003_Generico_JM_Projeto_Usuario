...
import usuarios_do_sistema_menu_e_submenu.Usuarios_do_Sistema_Menu_01;
 ...
 * @author NewUser
 */
public class Usuarios_Do_Sistema_00_Main extends JApplet {
    ...
    public void init() {
        ...
        Home.adicionar_Menu(new Usuarios_do_Sistema_Menu_01( Home ).Barra_Menu );
    ...
    public static void main(String[] args) {
        ...
        JApplet applet = new Usuarios_Do_Sistema_00_Main();
        applet.init();

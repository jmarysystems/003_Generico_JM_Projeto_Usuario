...
import visualizador_imagens.Visualizador_Banco_de_Dados;
    ...
    private void jButton7MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton7MousePressed
        ...
        if(status_cadastro.equalsIgnoreCase("Cadastrando...")){
            ...
            Home.ControleTabs.AddTabComControle(jTabbedPane1, "Visualizador Imagens Banco de Dados", "livroTp.gif", 
                        new Visualizador_Banco_de_Dados(Home, 0, status_cadastro, this ) ); 
...
//////////////////////////////////////////////////////
    ...
    private void tf_EmailMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tf_EmailMouseClicked
        try{
            PopupMenu_Colar = new PopupMenu_Colar(tf_Email);
        } catch( Exception e ){} 
